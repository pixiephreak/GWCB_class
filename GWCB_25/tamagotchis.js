...
DigitalPal.prototype.feed = function(){
    if(this.hungry === true){
      ...
      if(!this.sleepy){this.sleepy = true};
    }else{
...
DigitalPal.prototype.increaseAge = function(){
  this.age++;
  console.log(`Happy Birthday, I am ${this.age}`);
}

// DigitalPal.feed();
var tomi = new DigitalPal;
tomi.outside = false;
tomi.bark = function(){console.log("Bark!")};
tomi.goOutside = function(){
  console.log("Yay! I love the outdoors!");
  tomi.outside = !tomi.outside;
  bark();
}
tomi.sleepy = true;
tomi.sleep();
console.log(tomi.sleep);
